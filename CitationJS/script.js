...
btn.addEventListener("click", () =>{
    randomInt =  Math.round(Math.random() * arrayOfQuotes.length);
    quote.textContent = arrayOfQuotes[randomInt][0];
    author.textContent = arrayOfQuotes[randomInt][1];
    arrayOfQuotes.splice(randomInt,1);
